  ...
  <main>
    <div class="container">
      <form action="envia.php" method="POST" enctype="multipart/form-data" class="row g-3">
        ...
        <div class="col-mt-4">
          <label for="validationDefault02" class="form-label">Data de Contratação</label>
          <input type="date" class="form-control" name="data"id="validationDefault02"  required>
        </div>
        <div class="col-mt-4">
          <label for="validationTextarea" class="form-label">Estabelecimento</label>
          <input class="form-control" id="validationDefault01" placeholder="Nome do Estabelecimento" required name="description"></input>
